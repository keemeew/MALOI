...
/* 커스텀 헤더 labeling_t:
 *  - features(90), prediction(4), padding(2)
 *  => 총 96비트
 */
header features_t{
    bit<66> features;
...
struct metadata {
    bit<66> bnnInput;
    bit<66> NextLayerInput;
    bit<66> bnnInput2;

    bit<66> XNOROutput;
    bit<66> XNOROutput_next;
    ...
    bit<3>  predict_task6;
    bit<3>  predict_task12;
    bit<2>  predict_task10;
    bit<3>  predict_task2;
    bit<2>  predict_task13;
                  ...
                  inout standard_metadata_t standard_metadata)
{
     ...
     */
    register<bit<33>>(132) weights_bnn1;
    register<bit<33>>(132) weights_bnn2;
    
    register<bit<33>>(1024) weights_task6;
    register<bit<33>>(1024) weights_task12;
    register<bit<33>>(1024) weights_task10;
    register<bit<33>>(1024) weights_task2;
    register<bit<33>>(1024) weights_task13;
     ...
     **************************************/
    action XNOR_66(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput);
    }

    action BitCount_66(bit<66> bits) {
        ...
        // threshold ex) 45
        bit<4> activated = (x_ > 33) ? (bit<4>)1 : 0;
        meta.NextLayerInput = meta.NextLayerInput << 1;
        meta.NextLayerInput = meta.NextLayerInput + (bit<66>) activated;
    }

    /**************************************
     * LayerProcess1( offset=0..179 )
     **************************************/
    action LayerProcess1(bit<32> offset, bit<66> input_data) {
     ...
     **************************************/
    action XNOR_next_66(bit<66> w) {
        meta.XNOROutput_next = ~(w ^ meta.bnnInput2);
    }

    action BitCount_next_66(bit<66> bits) {
        bit<128> x_ = (bit<128>) bits;
     ...
     **************************************/
    action LayerProcess2(bit<32> offset, bit<66> input_data) {
        meta.NextLayerInput = 0;
        ...
        w = w + (bit<66>) wsub;
        XNOR_next_66(w);
        BitCount_next_66(meta.XNOROutput_next);
    ...
    action XNOR_task6(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput2);
    }

    action BitCount_t6_1(bit<66> bits) {
    ...
    action BitCount_t6_2(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_3(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_4(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_5(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_6(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_7(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action BitCount_t6_8(bit<66> bits) {
        bit<128> xx = (bit<128>)bits;
    ...
    action XNOR_task12(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput2);
    }
    
    action BitCount_t12_1(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t12_2(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t12_3(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t12_4(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t12_5(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t12_6(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action XNOR_task10(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput2);
    }
    
    action BitCount_t10_1(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t10_2(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action BitCount_t10_3(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
    ...
    action XNOR_task2(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput2);
    }
    
    action BitCount_t2_1(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_2(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_3(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_4(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_5(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_6(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_7(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t2_8(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action XNOR_task13(bit<66> w) {
        meta.XNOROutput = ~(w ^ meta.bnnInput2);
    }
    
    action BitCount_t13_1(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t13_2(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t13_3(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
    ...
    action BitCount_t13_4(bit<66> bits) {
        bit<128> xx = (bit<128>) bits;
        xx = (xx & m1) + ((xx >> 1) & m1);
        xx = (xx & m2) + ((xx >> 2) & m2);
        xx = (xx & m4) + ((xx >> 4) & m4);
