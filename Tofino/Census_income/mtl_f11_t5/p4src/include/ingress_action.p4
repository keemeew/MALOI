action preprocessing(bit<2> weight_1, bit<16> weight_2, bit<16> weight_3,
                     bit<16> weight_4, bit<16> weight_5) {
...
action XNOR_shared_2_1() {
    ig_md.meta.XNOROutput_1 = ~(ig_md.meta.weight_1 ^ hdr.intermediate_data1.intermediate_data_1[1:0]); // 기존: hdr.intermediate_data1.intermediate_data_1[9:0]
}
...
action XNOR_task_specific_1() {
    ig_md.meta.XNOROutput_1 = ~(ig_md.meta.weight_1 ^ hdr.intermediate_data2.intermediate_data_1[1:0]); // 기존: hdr.intermediate_data2.intermediate_data_1[9:0]
}
